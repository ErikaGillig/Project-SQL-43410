...
CREATE TABLE `intervencionquirurgica` (
  ...
  CONSTRAINT `intervencionquirurgica_ibfk_1` FOREIGN KEY (`id_hc`) REFERENCES `historiaclinica` (`id_hc`),
  CONSTRAINT `intervencionquirurgica_ibfk_2` FOREIGN KEY (`id_mascota`) REFERENCES `mascota` (`id_mascota`)
